...
class Jetpack_Widget_Conditions {
	...
	public static function widget_admin_setup() {
		...
		wp_enqueue_script( 'widget-conditions', plugins_url( 'widget-conditions/widget-conditions.js', __FILE__ ), array( 'jquery', 'jquery-ui-core' ), 20191128, true );
		wp_enqueue_script( 'widget-conditions', plugins_url( 'build/widget-visibility/widget-conditions/widget-conditions.min.js', __FILE__ ), array( 'jquery', 'jquery-ui-core' ), 20191128, true );
